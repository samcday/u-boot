...
'  fdtmap           90   243  fdtmap          90',
    ...
    def testAndroidBoot(self):
        ...
        self.assertEqual(b'test cmdline', header[12].split(b'\0', 1)[0])
        ...
        digest = hashlib.sha1()
        for payload in (U_BOOT_DATA, b'', b'', b'', U_BOOT_DTB_DATA):
