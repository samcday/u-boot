...
def run_test_suites(toolname, debug, verbosity, no_capture, test_preserve_dirs,
                    processes, test_names, toolpath, class_and_module_list):
    ...
    Args:
        ...
        test_preserve_dirs: True to preserve the input directory used by tests
            ...
            tests). If any tests are selected it also preserves their output
            directories. The preserved directories are displayed on the command
            line.
